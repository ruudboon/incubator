...
/*
  ...
  | Phalcon Framework                                                      |
  +------------------------------------------------------------------------+
  | Copyright (c) 2011-2019 Phalcon Team (https://www.phalconphp.com)      |
  +------------------------------------------------------------------------+
  ...
  +------------------------------------------------------------------------+
  | Authors: Ruud Boon <https://github.com/ruudboon>                       |
  +------------------------------------------------------------------------+
*/
 ...
 */
class Mssql extends Pdo implements AdapterInterface
{
